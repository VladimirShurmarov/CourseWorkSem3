                ...
                for (int j = 0; j < 8; j++)
                {
                    ...
                    switch (map[i,j]/10)
                    {
                        ...
                        case 1:
                            ...
                            graph.DrawImage(chessSprites, new Rectangle(0, 0, 50, 50), 0+150 * (map[i, j] % 10-1), 0, 150, 150, GraphicsUnit.Pixel);
                            butt.BackgroundImage = part;
                            break;
                        case 2:
                            Image part2 = new Bitmap(50, 50);
                            Graphics graph2 = Graphics.FromImage(part2);
                            graph2.DrawImage(chessSprites, new Rectangle(0, 0, 50, 50), 0+150 * (map[i, j] % 10-1), 150, 150, 150, GraphicsUnit.Pixel);
